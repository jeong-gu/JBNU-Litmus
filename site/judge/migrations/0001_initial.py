# Generated by Django 3.2.25 on 2024-08-06 16:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('key', models.CharField(blank=True, max_length=20, unique=True, validators=[django.core.validators.RegexValidator('^[a-z0-9]+$', 'Contest id must be ^[a-z0-9]+$')], verbose_name='contest id')),
                ...
                ('access_code', models.CharField(default='', help_text='An optional code to prompt contestants before they are allowed to join the contest. Leave it blank to disable.', max_length=255, verbose_name='access code')),
                ...
                ('is_practice', models.BooleanField(default=True, help_text='해당 설정값이 참이라면 실습으로 처리됩니다.', verbose_name='실습 여부')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('key', models.CharField(blank=True, help_text='The identifier for this language; the same as its executor id for judges.', max_length=6, unique=True, verbose_name='short identifier')),
                ('name', models.CharField(blank=True, help_text='Longer name for the language, e.g. "Python 2" or "C++11".', max_length=20, verbose_name='언어 이름')),
                ...
                ('common_name', models.CharField(help_text='Common name for the language. For example, the common name for C++03, C++11, and C++14 would be "C++".', max_length=10, verbose_name='언어 이름')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(default='default', help_text='A short, unique code for the problem, used in the URL after /problem/', max_length=20, unique=True, validators=[django.core.validators.RegexValidator('^[a-z0-9]+$', 'Problem code must be ^[a-z0-9]+$')], verbose_name='problem code')),
                ...
                ('memory_limit', models.PositiveIntegerField(blank=True, help_text='The memory limit for this problem, in kilobytes (e.g. 256mb = 262144 kilobytes).', null=True, verbose_name='memory limit')),
                ('memory_limit_1', models.PositiveIntegerField(default=256, help_text='The memory limit for this problem, in kilobytes (e.g. 256mb = 262144 kilobytes).', verbose_name='memory limit')),
                ('memory_unit', models.CharField(choices=[('KB', 'KB'), ('MB', 'MB')], default='MB', max_length=2, verbose_name='단위')),
                ('short_circuit', models.BooleanField(default=False, verbose_name='short circuit')),
                ('points', models.FloatField(default=1, help_text="Points awarded for problem completion. Points are displayed with a 'p' suffix if partial.", validators=[django.core.validators.MinValueValidator(0)], verbose_name='points')),
                ('partial', models.BooleanField(default=True, verbose_name='allows partial points')),
                ...
                ('date', models.DateTimeField(blank=True, db_index=True, null=True, verbose_name='date of publishing')),
                ...
                ('submission_source_visibility_mode', models.CharField(choices=[('F', 'Follow global setting'), ('A', 'Always visible'), ('S', 'Visible if problem solved'), ('O', 'Only own submissions')], default='F', max_length=1, verbose_name='제품 소스')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_banned_from_problem_voting', models.BooleanField(default=False, help_text="User will not be able to vote on problems' point values.", verbose_name='banned from voting on problem point values')),
                ...
                ('department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='judge.department')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('points', models.IntegerField(help_text='The amount of points the voter thinks this problem deserves.', validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(50)], verbose_name='proposed points')),
                ('vote_time', models.DateTimeField(auto_now_add=True, help_text='The time this vote was cast.', verbose_name='vote time')),
                ('note', models.TextField(blank=True, default='', help_text='Justification for problem point value.', max_length=8192, verbose_name='note')),
                ('problem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='problem_points_votes', to='judge.problem', verbose_name='problem')),
                ('voter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='problem_points_votes', to='judge.profile', verbose_name='voter')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='contest',
            name='authors',
            field=models.ManyToManyField(blank=True, help_text='These users will be able to edit the contest.', related_name='authored_contests', to='judge.Profile', verbose_name='authors'),
        ),
        migrations.AddField(
            model_name='contest',
            name='banned_users',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contest', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contest_moss', to='judge.contest', verbose_name='contest')),
                ('problem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contest_moss', to='judge.problem', verbose_name='problem')),
            ],
            options={

...
class Language(models.Model):
    ...
    name = models.CharField(max_length=20, verbose_name='언어 이름',
                            help_text=_('Longer name for the language, e.g. "Python 2" or "C++11".'),blank=True)
    ...
    common_name = models.CharField(max_length=10, verbose_name='언어 이름',
